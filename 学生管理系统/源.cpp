...
void Tab(const char* tex, int l,int z)
{
	...
	while (l!= z)
	{
		...
		Textmiddle(250, l, 740, l + 50, 30, "看这里");
	...
	while (l!= z)
	{
		Textmiddle(150, l, 240, l + 50, 30, "姓名");
		l += 60;
		Textmiddle(150, l, 240, l + 50, 30, "学号");
		l += 60;
		Textmiddle(150, l, 240, l + 50, 30, "专业");
		l += 60;
		Textmiddle(150, l, 240, l + 50, 30, "数学");
		l += 60;
		Textmiddle(150, l, 240, l + 50, 30, "英语");
		l += 60;
	}
	l = j;
	while (k==0)
...
void Deleteuser()
{
	...
	while (k == 0)
	{
		...
		{
		case WM_LBUTTONDOWN:
			if (m.x > 50 && m.y > 0 && m.x < 130 && m.y < 40)//返回按钮
			{
				k = 1;
				break;
			}
